...
# Suffix for DynamoDB Tables
db_table_suffix = "-vancouvergrizzlies"
...
def update():
    ...
    table_name = objtype.capitalize()+db_table_suffix
...
def write():
    ...
    # check header here
    content = request.get_json()
    table_name = content['objtype'].capitalize()+db_table_suffix
